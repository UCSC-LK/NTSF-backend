...
public class M_FineVehicleService {
    ...
    public String insertFineInfo(String location, String fineNo, String description, String policeId, String fineType, String vehicleNo) throws ParseException {
//        System.out.println("Inside insert fine info");
        JSONObject fineResponse = new JSONObject();
        M_FineVehicle fineVehicle = new M_FineVehicle(location,fineNo,description,policeId,fineType,vehicleNo);
