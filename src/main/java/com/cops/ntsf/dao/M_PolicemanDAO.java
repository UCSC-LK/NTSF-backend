...
import com.cops.ntsf.model.M_Policeman;
...
public class M_PolicemanDAO {
    public String createPoliceman(M_Policeman policeman)
    {
        Connection dbConn = null;
        try {
            dbConn = Database.getConnection();
            String sql = "INSERT into policeman (name, police_id, nic, mobile_no, email,  rank, police_station, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
//        ArrayList<Policeman> policemanDetails = new ArrayList<>(); //not used
    ...
    public boolean updatePolicemanDetails(M_Policeman policeman)
    {
        Connection dbConn = null;
        boolean alert = false;
...
//                String police_id = resultSet.getString("police_id");
    ...
    //////////////
    public void getPolicemanFromPoliceId(M_Policeman policeman){
        ...
        try {
            PreparedStatement preparedStatement = dbConn.prepareStatement(sql);
            preparedStatement.setString(1, policeman.getPolice_id());
            ResultSet resultSet = preparedStatement.executeQuery();
